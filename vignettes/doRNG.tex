...
\bibliography{/tmp/Rpkglib_5bee6b6c676/doRNG/REFERENCES}
...
\end{alltt}
\begin{verbatim}
## [1] 1.889 2.164 3.770 4.287 5.289
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## res1    24210    24210    24210    24210    24210
##         24240    24251    24240    24240    24240
## res2    24283    24303    24312    24312    24303
\end{verbatim}
\begin{alltt}
...
## 1        rPar(10)            5   0.068    1.000     0.067    0.000          0         0
## 3        rPar(25)            5   0.119    1.750     0.119    0.000          0         0
## 2        rRNG(10)            5   0.127    1.868     0.121    0.004          0         0
## 4        rRNG(25)            5   0.221    3.250     0.209    0.004          0         0
## 5        rPar(50)            5   0.239    3.515     0.239    0.000          0         0
## 6        rRNG(50)            5   0.376    5.529     0.366    0.000          0         0
## 9  rPar(10, 0.05)            5   2.578   37.912     0.074    0.000          0         0
## 10 rRNG(10, 0.05)            5   2.669   39.250     0.149    0.004          0         0
## 7  rPar(50, 0.01)            5   2.790   41.029     0.274    0.000          0         0
## 8  rRNG(50, 0.01)            5   2.900   42.647     0.381    0.004          0         0
\end{verbatim}
\end{kframe}
\end{knitrout}
