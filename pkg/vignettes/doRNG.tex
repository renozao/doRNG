...
\bibliography{/tmp/tmp.FsB5ZID5Yt/doRNG/REFERENCES}
...
\end{alltt}
\begin{verbatim}
## [1] 1.703 2.694 3.313 4.540 5.440
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## res1    22661    22661    22661    22661    22661
##         22686    22695    22695    22686    22695
## res2    22711    22720    22729    22720    22729
\end{verbatim}
\begin{alltt}
...
other attached packages:
 [1] doRNG_1.5        rngtools_1.0     pkgmaker_0.9.1   codetools_0.2-8  stringr_0.6.1   
