...
\title{\texttt{doRNG}: Unit testing results\footnote{Vignette computed  on Mon Nov  5 11:03:20 2012}}
\date{\texttt{doRNG} version 1.5 as of November  5, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle

\begin{verbatim}
RUNIT TEST PROTOCOL -- Mon Nov  5 11:03:20 2012 
*********************************************** 
...
\begin{itemize}\raggedright
  ...
  \item Other packages: codetools~0.2-8, digest~0.5.2, doMPI~0.1-5,
    ...
    pkgmaker~0.9.1, Rmpi~0.6-1, rngtools~1.0, RUnit~0.4.26,
    stringr~0.6.1
